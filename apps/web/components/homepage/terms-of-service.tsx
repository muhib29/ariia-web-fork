...
export function TermsOfService({ terms }: { terms: TermsOfServiceData }) {
  ...
  return (
    ...
    >
      ...
      <Header /> {/* //changed */}
      {/* Main Content */}
      <div className="px-5 max-w-6xl mx-auto z-10 relative pb-4 md:pb-8 bg-transparent md:bg-white">
