...
export default async function Homepage() {
  ...
  const heroProps = heroSection ? {
    leftContent: {
      ...
      typewriterText: heroSection.leftContent?.typerwriteText?.text?.map((t: any) => t.text) || [],
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <HomeBelowFold          // ✅ pass all below-fold props cleanly
        useCasesProps={useCasesProps}
        innovationProps={innovationProps}   // ✅ fixed — just pass the data
